...
# This script comes from https://github.com/fdcastel/Hyper-V-Automation,
# slightly edited to change paths to a couple of tools, and I like VM
# drives in separate folders.
...
& {
    & tools\qemu-img.exe convert -f qcow2 $SourcePath -O vhdx -o subformat=dynamic $vhdxPath
